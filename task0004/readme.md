# task0004 #
主要保存了任务四的第一个要求：Single Page Web App
使用hashchange实现了简单的路由功能，使用-webkit-translate3d简单实现动画效果，以及简单的touch手势响应。
as: [My todo](http://soaanyip.github.io/task0004/index.html)
