...
THREE.VRControls = function ( object, options, onError ) {
	...
	this.userHeight = options.userHeight || 1.6;
		...
		if ( vrInput ) {
			if ( vrInput.getPose ) {
				...
				if ( pose.position !== null ) {
					...
					autoSpeed(object, 0.001)
				} else {
					autoSpeed(object, 0.004)
				}
			...
			if ( this.standing &&  vrInput.stageParameters) {
	...
	function autoSpeed(camera, speed) {
